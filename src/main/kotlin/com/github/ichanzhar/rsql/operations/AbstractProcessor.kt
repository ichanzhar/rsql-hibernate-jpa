...
abstract class AbstractProcessor(protected val params: Params) : Processor {
    protected val log: XLogger = XLoggerFactory.getXLogger(this::class.java)
    ...
    private fun getPropertyNodeName(): String = params.globalProperty.substring(params.globalProperty.lastIndexOf(".") + 1)
}